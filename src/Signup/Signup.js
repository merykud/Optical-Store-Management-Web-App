                                ...
                                <div className="main-container">
                                        ...
                                        <form style = {formStyle} className="main-form" method="post">
                                            <div className="input-box">
                                                <div style = {formStyle} className="ui left icon input">
                                                    <input style = {inputStyle} type="username" placeholder="Username"></input>
                                            ...
                                            <div style = {formStyle} className="input-box">
                                                <div className="ui left icon input">
                                                    <input style = {inputStyle} type="password" placeholder="Password"></input>
                                    ...
                                    <div className="pt4">
                                        ...
                                        <div className="sign-up">
                                            <p style={linkStyle} className="signup-par"> Already have an account?
